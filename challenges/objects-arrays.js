...
console.log(`The ${raptor.name} had a ${raptor.diet} diet.`);

// How long was a stegosaurus?
console.log(`The ${steg.name} length ${steg.length}. length`);

// What time period did tyrannosaurus live in?
console.log(`The ${trex.name} lived during the ${trex.timePeriod}.`);
...
zooAnimals.forEach(function(currentValue) {
	displayNames.push(`Name: ${currentValue.display_name}, scientific: ${currentValue.scientific_name}.`);
});
...
const lowerPopulationAnimals = zooAnimals.filter(function(currentValue) {
